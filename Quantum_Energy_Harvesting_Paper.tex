...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{images/phase_diagram.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{images/noise_3_demon_flip.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{images/chain_dynamics.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{images/thermo_balance.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{images/quantum_landauer.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{images/integrated_engine_balance.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ai_10dot_dynamics.png}
...
\subsection{Appendix: Simulation Source Code}

本論文のシミュレーションおよび強化学習環境の構築に用いた主要なソースコード（Python / QuTiP / Stable Baselines 3）を以下に添付する。

\subsubsection{Appendix: \texttt{quantum\_10dot\_env.py}}
...
\subsubsection{Appendix: \texttt{train\_ai\_10dot\_chain.py}}
...
\section{Define model (using CPU for QuTiP stability)}
\section{Recurrent PPO uses an LSTM hidden state to track history and solve POMDP}
...
\section{Large-scale training to discover conveyor belt strategy}
...
\subsubsection{Appendix: \texttt{evaluate\_ai\_10dot\_chain.py}}
...
\subsubsection{Appendix: \texttt{simulate\_macroscopic\_quantum\_engine.py}}
...
\section{Calculate Net Work}
\section{Classical Memory: Erasure costs +kT * I_acc (in nats)}
w_erase_classical = i_acc * kT
net_work_classical = w_ext - w_erase_classical

\section{Quantum Entangled Memory: Erasure extracts +kT * I_acc (Negative cost)}
...
\section{Add text box indicating the breakthrough}
textstr = '\n'.join((
    r'Classical Cycle:',
    r'$W_{net} < 0$ (Dead)',
    r'',
...
\subsubsection{Appendix: \texttt{quantum\_demon\_env.py}}
